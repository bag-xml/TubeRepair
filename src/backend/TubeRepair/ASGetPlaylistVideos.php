...
if($kindResponse == "youtube#playlistItemListResponse" && str_contains($_SERVER["HTTP_USER_AGENT"], "com.google.ios.youtube/1.0") || $kindResponse == "youtube#playlistItemListResponse" && str_contains($_SERVER["HTTP_USER_AGENT"], "com.google.ios.youtube/1.1")|| $kindResponse == "youtube#playlistItemListResponse" && str_contains($_SERVER["HTTP_USER_AGENT"], "com.google.ios.youtube/1.2")){
	...
	$videoID = $decodeResponce['items'][$i]['snippet']['resourceId']['videoId'];
