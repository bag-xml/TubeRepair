<?php 
include "configuration.php"; //this is the bugged version of GetChannelVideos.php
if(isset($_GET["username"])){
	if(isset($_SERVER['HTTP_X_TUBEREPAIR_API_KEY'])){ $APIkey = $_SERVER['HTTP_X_TUBEREPAIR_API_KEY'];}else{exit;}
$curlConnectionInitialization = curl_init("https://" . $APIurl . "/youtube/v3/search?part=snippet&maxResults=" . $MaxCount . "&q=" . preg_replace('/\s+/', '', $_GET["username"]) ."&type=video&type=channel&order=date&key=" . $APIkey);
...
if($kindResponse == "youtube#searchListResponse"){
    ...
    <link rel="http://$baseURL/schemas/2007#video.complaints" type="application/atom+xml" href="https://api.tubefixer.ovh/feeds/api/videos/$videoID/complaints" />
    <link rel="http://$baseURL/schemas/2007#video.related" type="application/atom+xml" href="https://api.tubefixer.ovh/feeds/api/videos/$videoID/related" />
    <link rel="http://$baseURL/schemas/2007#video.captionTracks" type="application/atom+xml" href="https://api.tubefixer.ovh/feeds/api/videos/$videoID/captions" yt:hasEntries="false" />
    <link rel="http://$baseURL/schemas/2007#mobile" type="text/html" href="http://m.youtube.com/details?v=$videoID" />
    <link rel="http://$baseURL/schemas/2007#uploader" type="application/atom+xml" href="https://api.tubefixer.ovh/feeds/api/users/UCealgY8FrRPdAaCN8UtkuIQ" />
