...
if(isset($_GET["q"])){
$curlConnectionInitialization = curl_init("https://" . $APIurl . "/youtube/v3/search?part=snippet&maxResults=" . $MaxCount . "&q=" . preg_replace('/\s+/', '', $_GET["q"]) ."&type=video&key=" . $APIkey);
...
if($kindResponse == "youtube#searchListResponse" && str_contains($_SERVER["HTTP_USER_AGENT"], "com.google.ios.youtube/1.0") || $kindResponse == "youtube#searchListResponse" && str_contains($_SERVER["HTTP_USER_AGENT"], "com.google.ios.youtube/1.1")|| $kindResponse == "youtube#searchListResponse" && str_contains($_SERVER["HTTP_USER_AGENT"], "com.google.ios.youtube/1.2")){
...
$entry = <<<Entry
	<entry gd:etag='W/&quot;YDwqeyM.&quot;'>
		...
		<category scheme='http://schemas.google.com/g/2005#kind' term='http://gdata.youtube.com/schemas/1970#video'/>
		<category scheme='http://gdata.youtube.com/schemas/1970/categories.cat' term='Howto' label='Howto &amp; Style'/>
		...
		<link rel='http://gdata.youtube.com/schemas/1970#video.related' type='application/atom+xml' href='http://gdata.youtube.com/feeds/api/videos/$videoID/related?v=2'/>
		<link rel='http://gdata.youtube.com/schemas/1970#mobile' type='text/html' href='http://m.youtube.com/details?v=$videoID'/>
		<link rel='http://gdata.youtube.com/schemas/1970#uploader' type='application/atom+xml' href='http://gdata.youtube.com/feeds/api/users/$channelId?v=2'/>
		<link rel='related' type='application/atom+xml' href='http://gdata.youtube.com/feeds/api/videos/$videoID?v=2'/>
		<link rel='self' type='application/atom+xml' href='http://gdata.youtube.com/feeds/api/playlists/8E2186857EE27746/PLyl9mKRbpNIpJC5B8qpcgKX8v8NI62Jho?v=2'/>
		<author>
		...
		<gd:comments>
			<gd:feedLink rel='http://gdata.youtube.com/schemas/1970#comments' href='http://gdata.youtube.com/feeds/api/videos/$videoID/comments?v=2' countHint='5'/>
		</gd:comments>
		<yt:location>Paris ,FR</yt:location>
		<media:group>
			<media:category label='Howto &amp; Style' scheme='http://gdata.youtube.com/schemas/1970/categories.cat'>Howto</media:category>
		...
		<yt:recorded>1970-00-00</yt:recorded>
...
<feed
	...
	xmlns:yt='http://gdata.youtube.com/schemas/1970' gd:etag='W/&quot;D0UHSX47eCp7I2A9WhJWF08.&quot;'>
	<id>tag:youtube.com,2008:playlist:8E2186857EE27746</id>
	<updated>2012-08-23T12:33:58.000Z</updated>
	<category scheme='http://schemas.google.com/g/2005#kind' term='http://gdata.youtube.com/schemas/1970#playlist'/>
	<title></title>
	<subtitle></subtitle>
	...
	<link rel='http://schemas.google.com/g/2005#feed' type='application/atom+xml' href='http://gdata.youtube.com/feeds/api/playlists/8E2186857EE27746?v=2'/>
	<link rel='http://schemas.google.com/g/2005#batch' type='application/atom+xml' href='http://gdata.youtube.com/feeds/api/playlists/8E2186857EE27746/batch?v=2'/>
	<link rel='self' type='application/atom+xml' href='http://gdata.youtube.com/feeds/api/playlists/8E2186857EE27746?start-index=1&amp;max-results=25&amp;v=2'/>
	<link rel='service' type='application/atomsvc+xml' href='http://gdata.youtube.com/feeds/api/playlists/8E2186857EE27746?alt=atom-service&amp;v=2'/>
	<author>
		<name>$channelname</name>
		<uri>http://gdata.youtube.com/feeds/api/users/$channelId</uri>
		<yt:userId>$channelId</yt:userId>
