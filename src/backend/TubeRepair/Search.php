...
if($kindResponse == "youtube#searchListResponse" && str_contains($_SERVER["HTTP_USER_AGENT"], "com.google.ios.youtube/1.0") || $kindResponse == "youtube#searchListResponse" && str_contains($_SERVER["HTTP_USER_AGENT"], "com.google.ios.youtube/1.1")|| $kindResponse == "youtube#searchListResponse" && str_contains($_SERVER["HTTP_USER_AGENT"], "com.google.ios.youtube/1.2")|| $kindResponse == "youtube#searchListResponse" && str_contains($_SERVER["HTTP_USER_AGENT"], "Apple") ){
    ...
    <link rel="http://gdata.youtube.com/schemas/2007#video.complaints" type="application/atom+xml" href="https://$baseURL/feeds/api/videos/$videoID/complaints" />
    <link rel="http://gdata.youtube.com/schemas/2007#video.related" type="application/atom+xml" href="https://$baseURL/feeds/api/videos/$videoID/related" />
    <link rel="http://gdata.youtube.com/schemas/2007#video.captionTracks" type="application/atom+xml" href="https://$baseURL/feeds/api/videos/$videoID/captions" yt:hasEntries="false" />
    <link rel="http://gdata.youtube.com/schemas/2007#mobile" type="text/html" href="http://m.youtube.com/details?v=$videoID" />
    <link rel="http://gdata.youtube.com/schemas/2007#uploader" type="application/atom+xml" href="https://$baseURL/feeds/api/users/UCealgY8FrRPdAaCN8UtkuIQ" />
    ...
    <gd:comments><gd:feedLink href='https://www.google.com/$serverScriptDirectory/GetComments.php?videoId=$videoID'/></gd:comments>
